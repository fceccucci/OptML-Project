...
def build_shared_dataset(cfg) -> Dataset:
    ...
    beta = cfg.partition.share_fraction             
...
def build_client_loaders(
    ...
    client_D_idcs = dirichlet_partition(D_labels, cfg.num_clients, num_classes, cfg.partition.alpha)
    ...
    alpha_dist = cfg.partition.alpha_dist
    ...
    test_idcs_all = dirichlet_partition(test_labels, cfg.num_clients, num_classes, cfg.partition.alpha)
